...
const MessageScheduler = ({ onSchedule, onEdit, onDelete, scheduledMessages = [] }) => {
    ...
    <Box sx={{ width: '100%' }}>
      <Paper elevation={3} sx={{ p: 2 }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
          ...
          <Button variant='contained' startIcon={<ScheduleIcon />} onClick={handleOpen}>
            Schedule New
          </Button>
        </Box>
                  ...
                  secondary={
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        ...
                        <Typography variant='body2'>{formatDateTime(msg.scheduledDate)}</Typography>
                      </Box>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        <RepeatIcon fontSize='small' color='action' />
                        <Typography variant='body2'>{getRepeatText(msg.repeat)}</Typography>
                      </Box>
                    </Box>
                  }
                />
